    ...
    <section class="product-grid">
        <section class="product-items">
            <?php if (count($products) > 0): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p>No products found matching your search. Try adjusting your filters or <a href="main.php">view all
                        products</a>.</p>
            <?php endif; ?>
        </section>
        <nav class="pagination">
            <?php if ($page > 1): ?>
                <a href="main.php?page=<?php echo $page - 1; ?>" class="previous">Previous</a>
            <?php endif; ?>
            <?php if ($page < $totalPages): ?>
                <a href="main.php?page=<?php echo $page + 1; ?>" class="next">Next</a>
            <?php endif; ?>
        </nav>
    </section>
</main>
